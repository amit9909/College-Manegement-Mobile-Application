...
public class BipStudentMainActivity extends AppCompatActivity  {
...
//        headerName.setText();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.bip_student_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_log_out: {
                mAuth.signOut();
                Intent intent = new Intent(BipStudentMainActivity.this, BipLogInActivity.class);
