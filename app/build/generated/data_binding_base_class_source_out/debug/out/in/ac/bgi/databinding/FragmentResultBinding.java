...
public final class FragmentResultBinding implements ViewBinding {
  ...
  private FragmentResultBinding(@NonNull FrameLayout rootView, @NonNull TextView textResult) {
  ...
  public static FragmentResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentResultBinding((FrameLayout) rootView, textResult);
    }
