...
public final class FragmentSlideshowBinding implements ViewBinding {
  ...
  private FragmentSlideshowBinding(@NonNull FrameLayout rootView, @NonNull TextView textSlideshow) {
  ...
  public static FragmentSlideshowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSlideshowBinding((FrameLayout) rootView, textSlideshow);
    }
