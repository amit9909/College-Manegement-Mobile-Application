...
public final class FragmentGalleryBinding implements ViewBinding {
  ...
  private FragmentGalleryBinding(@NonNull FrameLayout rootView, @NonNull TextView textGallery) {
  ...
  public static FragmentGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGalleryBinding((FrameLayout) rootView, textGallery);
    }
